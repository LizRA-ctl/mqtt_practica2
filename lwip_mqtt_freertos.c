...
static const struct mqtt_connect_client_info_t mqtt_client_info = {
    ...
    .client_user = "lizruza13",
    .client_pass = "aio_KBIT5568zKjrBiM7PWtiXBdWcCDv",
    .keep_alive  = 100,
    .will_topic  = NULL,
    .will_msg    = NULL,
    .will_qos    = 0,
...
{
    static const char *topics[] = {"lizruza13/feeds/boton-de-emergencia","lizruza13/feeds/temperatura"};
    int qos[]                   = {1,1};
    err_t err;
    int i;
...
{
	static const char *topic   = "lizruza13/feeds/consejos";
	static const char *message = "Consulta a médico si presentas síntomas";
	static const char *topic1   = "lizruza13/feeds/porcentaje-hospitalario";
	static const char *message1 = "60";
	static const char *topic2   = "lizruza13/feeds/semaforo";
	static const char *message2 = "0";
	err_t err;
    ...
    PRINTF("Going to publish to the topic \"%s\"...\r\n", topic1);
    err= mqtt_publish(mqtt_client, topic1, message1, strlen(message1), 1, 0, mqtt_message_published_cb, (void *)topic1);
    if (err != ERR_OK){
        	PRINTF("failed1");}
